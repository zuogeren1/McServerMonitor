      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 h-14 border-b border-(--color-border) shrink-0">
          ...
          {!collapsed && (
            <button
              onClick={toggleTheme}
              className="ml-auto p-1 rounded hover:bg-(--color-hover) transition-colors"
              title="切换主题"
            >
        ...
        {!isMobile && (
          <div className="p-2 border-t border-(--color-border)">
            <button
              ...
              className="flex items-center gap-2 w-full px-2 py-1.5 rounded text-(--color-muted) hover:bg-(--color-hover) hover:text-(--color-text) transition-colors text-sm"
    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : 'text-(--color-muted) hover:bg-(--color-hover) hover:text-(--color-text)'
      )}
    >
